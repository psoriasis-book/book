...
The biological rationale is well-established. Adipose tissue (body fat) produces pro-inflammatory cytokines including TNF-α and IL-6, which feed into the same inflammatory pathways that drive psoriasis. Obesity also reduces the efficacy of biologic therapies, particularly fixed-dose regimens where patients above 100 kg are less likely to achieve optimal responses. So weight loss can improve treatment response as well [(Puig, 2011)](https://pubmed.ncbi.nlm.nih.gov/21492252/).
...
Stress is a well-documented trigger for psoriasis flares (Section 8.3), and several small studies have explored whether stress-reduction interventions can improve outcomes. In a landmark trial, Kabat-Zinn et al. randomised 37 patients undergoing UV phototherapy to either listen to a mindfulness meditation tape during treatment or receive light treatment alone. The MBSR group reached both the halfway point and the clearing point significantly faster [(Kabat-Zinn et al., 1998)](https://pubmed.ncbi.nlm.nih.gov/9773769/). A 2022 systematic review identified five additional studies of mindfulness or meditation for psoriasis, most showing trends towards benefit but limited by small sample sizes [(Bartholomew et al., 2022)](https://pmc.ncbi.nlm.nih.gov/articles/PMC9515248/). No clinical guideline currently recommends specific stress-reduction protocols for psoriasis management, though the biological plausibility is strong (Section 8.3).
...
Physical activity is an under-recognised but evidence-based adjunct intervention for psoriasis. A 2024 meta-analysis confirmed that psoriasis patients have significantly lower levels of high-intensity exercise than healthy controls, and that this physical inactivity contributes to the elevated cardiovascular and metabolic risk profile discussed in Section 14 [(Zhu et al., 2024)](https://pmc.ncbi.nlm.nih.gov/articles/PMC11589643/).

**Exercise improves psoriasis severity directly.** An interventional study found that a structured exercise programme promoted significant skin clearance, with 50% of participants achieving PASI-50 response at week 20 [(Sheppard et al., 2024)](https://onlinelibrary.wiley.com/doi/full/10.1002/ski2.426). The biological mechanisms likely include:
