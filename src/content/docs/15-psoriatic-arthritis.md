...
- **Plain radiographs** may show erosions, joint space narrowing, and two features relatively specific to PsA: **juxta-articular new bone formation** (proliferative bone changes near joints, unlike the purely erosive pattern of rheumatoid arthritis) and, in severe cases, the **"pencil-in-cup" deformity** — where erosion sharpens the distal end of one phalanx to a pencil-like point while the adjacent bone base is eroded into a cup-like concavity. This appearance is seen in approximately 5–16% of PsA patients and is characteristic of arthritis mutilans, the most destructive form of PsA.
...
**Peripheral arthritis.** First-line treatment is NSAIDs (non-steroidal anti-inflammatory drugs) for mild disease. If inadequate, conventional synthetic DMARDs (disease-modifying anti-rheumatic drugs) — principally methotrexate — are used. For moderate-to-severe disease or DMARD failure, biologic therapies are indicated: TNF-α inhibitors, IL-17 inhibitors, IL-23 inhibitors, and JAK inhibitors are all effective. IL-12/23 inhibition (ustekinumab) and PDE4 inhibition (apremilast) are alternatives.

**Axial disease.** Conventional DMARDs (including methotrexate) are **not effective** for axial PsA — this is an important difference from peripheral disease. NSAIDs are first-line, and biologic therapies (TNF-α inhibitors, IL-17 inhibitors, JAK inhibitors) are used for inadequate NSAID response.
