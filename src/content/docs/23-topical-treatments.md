...
Emollients work by restoring the disrupted skin barrier that is a hallmark of psoriatic skin. Even non-lesional (clinically normal-looking) skin in psoriasis patients shows increased transepidermal water loss and abnormal lipid composition. Regular emollient use reduces scaling, relieves itch, improves skin comfort, and may reduce the amount of active topical treatment needed. A systematic review confirmed that emollients used as adjuncts to topical corticosteroids improve clinical outcomes compared to corticosteroids alone [(Van Zuuren et al., 2017)](https://pubmed.ncbi.nlm.nih.gov/28166084/).
