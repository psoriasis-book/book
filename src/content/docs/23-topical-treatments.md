...
Emollients work by restoring the disrupted skin barrier that is a hallmark of psoriatic skin. Even non-lesional (clinically normal-looking) skin in psoriasis patients shows increased transepidermal water loss and abnormal lipid composition. Regular emollient use reduces scaling, relieves itch, improves skin comfort, and may reduce the amount of active topical treatment needed. A clinical study confirmed that emollients used as adjuncts to topical corticosteroids improve clinical outcomes compared to corticosteroids alone [(Heim et al., 2022)](https://pubmed.ncbi.nlm.nih.gov/36054319/).

**Choosing an emollient.** Ointments (e.g., white soft paraffin, emulsifying ointment) are the most effective at trapping moisture but are greasy. Creams are better tolerated cosmetically but less occlusive. Lotions are best for hairy areas. Aqueous cream BP should be avoided as a leave-on product: it contains sodium lauryl sulfate, which can irritate psoriatic skin. The best emollient is the one the patient will actually use consistently, applied liberally at least twice daily and especially after bathing.

**Practical tip.** Apply emollients first, wait 15-30 minutes, then apply active topical treatments on top. This maximises hydration without diluting the active agent.
