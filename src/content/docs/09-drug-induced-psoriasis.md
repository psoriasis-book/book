...
**Lithium**, used for bipolar disorder, is a well-established psoriasis trigger. Long-term lithium use is associated with an odds ratio of 1.68 for incident psoriasis (95% CI: 1.18–2.39). Lithium inhibits inositol monophosphatase and glycogen synthase kinase-3b (GSK-3b), leading to increased pro-inflammatory cytokine production and impaired keratinocyte differentiation [(Balak & Hajdarbegovic, 2017)](https://pmc.ncbi.nlm.nih.gov/articles/PMC5774610/).
