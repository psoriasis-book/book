...
description: "Comprehensive overview of psoriasis treatments including biologic therapies, biosimilars, small molecule inhibitors, conventional systemic agents, phototherapy, and cost considerations."
sidebar:
  order: 24
---
...
The introduction of biologic therapies has transformed the treatment of moderate-to-severe psoriasis over the past two decades [(Armstrong & Read, 2020)](https://pubmed.ncbi.nlm.nih.gov/32427307/).

![Biologic drug targets in the psoriasis immune cascade](./images/biologic-targets.svg)

## 24.2 Biologic Therapies

Biologics are engineered proteins, typically antibodies (immune proteins that bind to and neutralise specific targets) or fusion proteins (lab-created molecules that combine parts of two different proteins), designed to block specific components of the immune system. Unlike traditional drugs, which are small chemical molecules, biologics are large, complex proteins manufactured in living cells. They're grouped by the immune target they block:

### TNF-α Inhibitors (First Generation)
The first biologics approved for psoriasis. These block TNF-α, a major pro-inflammatory cytokine. They've been superseded by newer agents with superior efficacy, but TNF-α inhibitors remain valuable for patients with concurrent psoriatic arthritis, where they have strong evidence of efficacy, and their long-term safety profile is well-established [(ten Bergen et al., 2020)](https://onlinelibrary.wiley.com/doi/10.1111/sji.12946). Approved agents include:
...
- **Adalimumab (Humira)**: A fully human monoclonal antibody (a lab-made antibody designed to target one specific molecule, in this case TNF-α. "Monoclonal" means all copies are identical, and "fully human" means it's made entirely from human protein sequences, reducing the chance of the body rejecting it), given as a subcutaneous injection every two weeks. Once the world's best-selling drug. PASI 90 rates ~45%.
...
- **Certolizumab pegol (Cimzia)**: A PEGylated antibody fragment (just the business end of an antibody, coated with a polymer called PEG to make it last longer in the body). It doesn't cross the placenta and is therefore considered the preferred biologic option during pregnancy.

### IL-12/23 Inhibitor
**Ustekinumab (Stelara)** targets the p40 subunit shared by IL-12 and IL-23, blocking both cytokines. It was the first biologic to target the IL-23 pathway and demonstrated that blocking upstream drivers of Th17 differentiation was effective. Administered subcutaneously every 12 weeks after induction, with weight-based dosing (45 mg for patients ≤100 kg, 90 mg for >100 kg) [(Armstrong & Read, 2020)](https://pubmed.ncbi.nlm.nih.gov/32427307/).
...
- **Deucravacitinib (Sotyktu)**: FDA-approved in September 2022, this is a selective tyrosine kinase 2 (TYK2) inhibitor. TYK2 is a member of the JAK enzyme family that sits inside cells and relays signals from the IL-23, IL-12, and type I interferon receptors. By blocking TYK2, deucravacitinib interrupts these specific signalling pathways without broadly suppressing the immune system, offering a more targeted approach than older, non-selective JAK inhibitors [(Drakos et al., 2024)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10819460/).

### JAK Inhibitor Safety: The ORAL Surveillance Signal

JAK inhibitors deserve a safety note. Tofacitinib (Xeljanz), a non-selective JAK inhibitor approved for psoriatic arthritis (not plaque psoriasis), was the subject of the ORAL Surveillance trial, which compared tofacitinib to TNF inhibitors in rheumatoid arthritis patients aged 50+ with at least one cardiovascular risk factor. The trial found increased rates of major adverse cardiovascular events (MACE), venous thromboembolism (VTE), and malignancy with tofacitinib compared to TNF inhibitors [(Ytterberg et al., 2022)](https://pubmed.ncbi.nlm.nih.gov/35081280/).

This signal led the FDA to add boxed warnings to all JAK inhibitors and restrict their use to patients who have failed TNF inhibitor therapy. How relevant is this to psoriasis? The ORAL Surveillance population (elderly RA patients with pre-existing cardiovascular risk) differs substantially from the typical psoriasis biologic population. Deucravacitinib (the TYK2 inhibitor used in psoriasis) targets a much narrower kinase and has not shown similar cardiovascular or thromboembolic signals in its trial programme. Nonetheless, the class-wide FDA warnings technically apply, and clinicians prescribing any JAK-pathway drug should assess cardiovascular risk factors.
...
- **Dimethyl fumarate (Skilarence)**: An oral fumaric acid ester approved for moderate-to-severe plaque psoriasis in Europe (EMA-approved 2017) but not in the US. Fumaric acid esters have been used for psoriasis in Germany since the 1950s, making them one of the oldest systemic therapies. Dimethyl fumarate activates the Nrf2 antioxidant pathway and shifts immune responses from Th1/Th17 towards Th2, reducing inflammatory cytokine production [(Mrowietz et al., 2018)](https://pubmed.ncbi.nlm.nih.gov/30238510/). Common side effects include gastrointestinal symptoms (particularly in the first weeks) and flushing. Lymphopenia requires monitoring. It occupies a niche role in European practice as an oral option for patients who can't use or don't want methotrexate.
...
**Rotational and sequential therapy.** Before the biologic era, rotational therapy (cycling between different conventional systemics: methotrexate, then cyclosporine, then acitretin) was a common strategy to limit cumulative organ toxicity from any single agent. This approach is less necessary with modern biologics but remains relevant for patients on conventional systemics who can't access biologic therapy.

**Transition periods.** When switching between systemic therapies, overlap strategies may be needed to prevent flares during the transition. When switching from cyclosporine to a biologic, for example, the cyclosporine may be tapered gradually over several weeks while the biologic takes effect, rather than being stopped abruptly.
...
**Secondary loss of efficacy (LOE)** is the more common problem: an initially good response gradually declines during the maintenance phase. This occurs through several mechanisms, most notably the development of **anti-drug antibodies (ADAs)**, which neutralise the biologic and reduce its effective concentration. ADA formation is highest for adalimumab (~32%) and infliximab (~30%), and lowest for secukinumab (<1%). Rates vary within classes: among IL-23 inhibitors, guselkumab and tildrakizumab have relatively low rates (~8%), while risankizumab has a higher rate of treatment-emergent ADAs (~22%), though the vast majority are low-titre and non-neutralising, with no clinically meaningful impact on efficacy [(Sun et al., 2024)](https://pubmed.ncbi.nlm.nih.gov/38499168/). Drug survival data from the BADBIR registry show that approximately 23% of patients discontinue their first biologic within year 1, rising to 47% by year 3 [(Warren et al., 2015)](https://doi.org/10.1038/jid.2015.208).
...
- **Between-class switching** (e.g., TNF inhibitor to IL-17, then to IL-23): Preferred when primary non-response suggests the targeted pathway isn't the patient's dominant driver. Between-class switching is associated with longer drug survival in registry data and has become the predominant strategy since IL-17 and IL-23 inhibitors became available [(Yiu et al., 2020)](https://doi.org/10.1111/bjd.18981).

**Dose escalation vs. switching.** When a biologic loses efficacy, switching to a different drug isn't the only option. Dose escalation — shortening the interval between doses or increasing the dose — can recapture response in some patients, particularly when loss of efficacy is driven by pharmacokinetic factors (the drug being cleared too quickly) rather than a fundamental pathway mismatch. For adalimumab, shortening the interval from every 2 weeks to weekly is a well-established rescue strategy. For IL-17 and IL-23 inhibitors, dose interval shortening is used in clinical practice but has less formal trial evidence. The trade-off is straightforward: dose escalation preserves the known mechanism and avoids the uncertainty of switching, but it increases drug exposure, cost, and potentially side effects. If dose escalation doesn't restore adequate control within 12–16 weeks, switching is the next step.
...
**Conventional systemics as the global backbone.** In most LMICs, methotrexate, available, inexpensive, and effective for both skin and joint disease, remains the primary systemic treatment. Cyclosporine and acitretin are also used where available. These agents carry more monitoring requirements and side effects than biologics, but they're the only realistic options for the majority of moderate-to-severe psoriasis patients worldwide.

**Biosimilar impact on global access.** The arrival of biosimilars (Section 24.4) has the potential to transform global access. Infliximab biosimilars have already reduced annual treatment costs from tens of thousands of dollars to approximately $1,664 per year in the US, and costs are even lower in countries such as India. As biosimilars become available for adalimumab (from 2023) and ustekinumab (from 2025), biologic therapy may become accessible in upper-middle-income countries for the first time. Cold-chain requirements (most biologics require refrigeration), injection administration infrastructure, and monitoring needs remain barriers, though.
