...
Studies have consistently shown that carrying one copy of HLA-C*06:02 increases psoriasis risk by approximately 206%, and the allele accounts for the single largest genetic effect in the disease [(Chen et al., 2011)](https://doi.org/10.1371/journal.pone.0019454). However, HLA-C*06:02 only explains approximately 6.7% of the total genetic heritability of psoriasis, indicating that many other genes contribute to disease risk [(Chen et al., 2011)](https://doi.org/10.1371/journal.pone.0019454).
