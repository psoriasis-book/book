...
- **Skin barrier function**: Deletions in the late cornified envelope genes LCE3B and LCE3C, which encode proteins involved in the terminal differentiation of the skin's outermost layer, are associated with psoriasis susceptibility [(Riveira-Munoz et al., 2011; cited in Patel et al., 2023)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10418823/).
