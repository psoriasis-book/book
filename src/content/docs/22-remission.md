---
title: "Remission and Spontaneous Clearance"
description: "Understanding remission in psoriasis — definitions, spontaneous clearance rates for guttate and chronic plaque psoriasis, and modern treatment goals."
sidebar:
  order: 22
---
...
- A larger, long-term follow-up study of 120 patients with new-onset guttate psoriasis (mean follow-up 6.2 years) found that 50.9% achieved complete remission, while 49.1% had persistent psoriatic disease. Of the total cohort, 17.5% had switched to the plaque psoriasis phenotype [(Galili et al., 2023)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10015744/).
...
Registry data and several prospective studies suggest you can. The CONDOR trial randomised 120 patients on stable biologics to dose reduction versus usual care: 53% of patients in the dose reduction group successfully tapered their dose at 12 months [(Atalay et al., 2020)](https://pubmed.ncbi.nlm.nih.gov/32049319/). A scoping review of 19 studies found varying success rates across different biologics, with the proportion maintaining disease control during dose tapering ranging widely depending on the drug and protocol [(Michielsens et al., 2021)](https://pubmed.ncbi.nlm.nih.gov/33453052/). The GUIDE trial (Section 27.3) is the most rigorous test of this approach, using structured guselkumab tapering in super-responders. IL-23 inhibitors appear particularly suited to interval extension because of their upstream mechanism: by blocking the master switch rather than the downstream effectors, they may achieve deeper immunological remission.
