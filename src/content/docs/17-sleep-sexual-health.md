...
**Female fertility** is less studied, but emerging data suggest psoriasis may affect it too. Chronic systemic inflammation can disrupt the hypothalamic-pituitary-ovarian axis, and elevated TNF-α and IL-6 have been associated with impaired ovarian reserve and altered follicular development. Small observational studies have reported lower anti-Müllerian hormone (AMH) levels in women with moderate-to-severe psoriasis compared with age-matched controls, suggesting reduced ovarian reserve, though larger studies are needed to confirm this finding. Polycystic ovary syndrome (PCOS), which shares inflammatory and metabolic pathways with psoriasis, is also reported at higher rates in women with psoriasis. The practical implication: women with psoriasis who are having difficulty conceiving should have fertility assessed, and active disease control may itself improve reproductive outcomes.
