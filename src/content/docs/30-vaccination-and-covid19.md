...
- **Biologics (anti-TNF, anti-IL-17, anti-IL-23):** A longitudinal cohort study found that seroconversion after a completed two-dose COVID-19 vaccination course was achieved in 100% of participants on targeted biological therapies, comparable to healthy controls. Antibody titres were numerically slightly lower but not significantly different. Cellular immune responses (T-cell function) were largely unaffected [(Mahil et al., 2022)](https://pubmed.ncbi.nlm.nih.gov/34778846/).
