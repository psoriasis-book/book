...
**Natural course during pregnancy.** Approximately 55% of women with psoriasis experience improvement during pregnancy, likely due to the shift from Th1/Th17-dominant immunity towards a Th2-dominant profile that occurs naturally to protect the foetus from the mother's immune system [(Murase et al., 2005)](https://pubmed.ncbi.nlm.nih.gov/15897382/). Roughly 23% of women experience worsening, though, and postpartum flares within the first few months after delivery are common.
...
- **Methotrexate** is highly teratogenic, associated with pregnancy loss and congenital anomalies including microcephaly, craniosynostosis, limb defects, and tetralogy of Fallot. It must be stopped at least 3 months before conception in women. For men, the 2024 EULAR update now considers standard-dose methotrexate (up to 25 mg/week) compatible with paternal conception without a mandatory washout, based on registry data showing no adverse birth outcomes. Some guidelines (including BAD) have not yet incorporated this update, so patients should discuss this with their prescribing clinician.
...
**Biologics during pregnancy.** The landscape is evolving rapidly, with increasing evidence that biologics may be safer than previously assumed:

- **Certolizumab pegol** is the preferred biologic during pregnancy. Unlike all other biologics, it lacks the Fc region (the part of the antibody that is actively transported across the placenta), so it doesn't cross the placenta in significant amounts. The landmark CRIB study confirmed negligible foetal exposure [(Mariette et al., 2018)](https://pubmed.ncbi.nlm.nih.gov/29030361/). Certolizumab is also minimally excreted in breast milk, making it safe during breastfeeding without modification of the infant vaccination schedule.
- **Other TNF inhibitors** (adalimumab, etanercept, infliximab) can be used during the first half of pregnancy. Because they are IgG1 antibodies with Fc regions, they are actively transferred across the placenta during the second and third trimesters. If used beyond week 20, live vaccines (such as BCG and rotavirus) should be delayed in the infant until 6 months of age.
- **IL-17 and IL-23 inhibitors**: Data are more limited. A 2025 WHO pharmacovigilance analysis of over 140 million reports found that most biologics (including secukinumab, ixekizumab, guselkumab, and tildrakizumab) had lower frequencies of pregnancy-related adverse outcomes compared to TNF inhibitors. Risankizumab, however, showed a signal for increased abortion and stillbirth risk (reporting odds ratio 1.87, 95% CI 1.32–2.63) [(Jeong et al., 2025)](https://pubmed.ncbi.nlm.nih.gov/39626647/). This comes from spontaneous reporting data (WHO VigiBase), which is subject to significant reporting bias and confounding. A reporting odds ratio is not the same as a true risk ratio, so this signal requires confirmation in controlled studies before drawing clinical conclusions. Current consensus recommends discontinuing IL-17 and IL-23 inhibitors when pregnancy is confirmed unless no safer alternative exists.
...
The handover from paediatric to adult dermatology, typically between ages 16 and 18 in the UK, is a high-risk period. Adolescents lose the care team they've known since childhood, face clinicians unfamiliar with their history, and are expected to self-manage a condition their parents previously handled. The timing couldn't be worse: it coincides with exam stress, social upheaval, and the developmental stage where appearance matters most.

Evidence from other chronic diseases (type 1 diabetes, IBD, cystic fibrosis) consistently shows that unstructured transitions lead to treatment dropout, missed appointments, and disease flare. Psoriasis-specific transition data are limited, but the principles are the same. Young adults with psoriasis are at particular risk of stopping biologic therapy, missing monitoring bloods, and losing contact with specialist services altogether.

What does good transition look like? Ideally, a structured programme starting 1–2 years before the move: joint clinics where paediatric and adult teams overlap, a named key worker or nurse specialist who bridges the gap, a written transition plan covering medications, monitoring, and who to contact in a flare, and gradual transfer of responsibility from parent to patient. In practice, few NHS trusts have psoriasis-specific transition pathways, though the situation is improving. If you're a parent of a teenager with psoriasis approaching transition, ask your dermatology team what the plan is. If there isn't one, push for a structured handover rather than an abrupt switch.
...
**Prevalence.** Psoriasis prevalence is highest in white populations (approximately 3.6% in the US), but it also affects Asian (2.5%), Hispanic (1.9%), and Black (1.5%) populations at substantial rates [(Armstrong et al., 2021)](https://doi.org/10.1001/jamadermatol.2021.2007). These lower rates may partly reflect underdiagnosis rather than true lower prevalence.
...
**Research gaps.** Clinical trials for new psoriasis medications have historically had very low representation of non-white participants, limiting knowledge of how treatments perform across diverse populations. The VISIBLE study (NCT05272150), initiated in 2022, was specifically designed to assess guselkumab in patients with skin of colour and represents a growing recognition of this evidence gap. HLA-C*06:02 positivity, the strongest genetic risk factor, is generally higher in white populations than in Asian populations, and few genome-wide association studies have focused on African ancestry. That's a critical genetic research gap.

## 21.4 Elderly Patients

Psoriasis in older adults (typically defined as age 65 and over) presents distinct management challenges that aren't well addressed in clinical guidelines, despite the ageing population representing a growing proportion of psoriasis patients.

**Accumulated comorbidity burden.** Elderly patients with long-standing psoriasis carry the cumulative effects of decades of systemic inflammation, the "psoriatic march" (Section 14.7). They're more likely to have established cardiovascular disease, type 2 diabetes, chronic kidney disease, and hepatic impairment. These comorbidities complicate treatment selection: methotrexate may be contraindicated by renal or hepatic impairment, and ciclosporin carries heightened nephrotoxicity risk in patients with pre-existing renal disease or hypertension.
