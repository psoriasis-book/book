...
Psoriatic patients show altered plasma lipid profiles, with increased lipid peroxidation products and decreased levels of protective antioxidant enzymes (superoxide dismutase, catalase, glutathione peroxidase). Metabolomics studies using liquid chromatography-mass spectrometry (LC-MS) have identified dysregulation of amino acids, carnitines, fatty acids, and lipids that correlate with disease severity and improve with anti-TNF treatment [(Kar et al., 2024)](https://pmc.ncbi.nlm.nih.gov/articles/PMC11305507/).
