...
In psoriasis, this protective mechanism is impaired. Mutations in **AP1S3**, a gene encoding a subunit of the AP-1 adaptor protein complex involved in intracellular vesicle trafficking, disrupt autophagy and lead to abnormal accumulation of **p62** (an autophagy cargo receptor). Accumulated p62 activates the NF-kB signalling cascade (Section 6.5), resulting in accelerated IL-1 signalling and overexpression of **IL-36a**. That directly connects autophagy dysfunction to the IL-36 axis described above [(Mahil et al., 2016)](https://pubmed.ncbi.nlm.nih.gov/27388993/).
