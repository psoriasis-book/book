...
In psoriasis, this protective mechanism is impaired. Mutations in **AP1S3**, a gene encoding a component of the autophagy machinery, lead to reduced autophagy function and abnormal accumulation of **p62** (an autophagy cargo receptor). Accumulated p62 activates the NF-kB signalling cascade (Section 6.5), resulting in accelerated IL-1 signalling and overexpression of **IL-36a**. That directly connects autophagy dysfunction to the IL-36 axis described above [(Mahil et al., 2024)](https://www.sciencedirect.com/science/article/abs/pii/S156757692400763X).
