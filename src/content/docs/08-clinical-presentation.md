...
- **PGA × BSA (Physician's Global Assessment × Body Surface Area)** — a composite score that multiplies a physician's overall severity rating by the percentage of body surface area affected. This intuitive measure is more sensitive than PASI for detecting change in mild-to-moderate disease and is easier to calculate. It has been validated as a reliable alternative to PASI in clinical trial settings [(Langley et al., 2015)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10389140/).
