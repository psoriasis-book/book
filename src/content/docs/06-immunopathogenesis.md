...
- **The gut-skin axis**: The gut microbiome (the trillions of bacteria living in the intestines) increasingly appears to play a role in psoriasis. Patients with psoriasis show altered gut microbiota composition, a state called dysbiosis, and increased gut barrier permeability ("leaky gut"), which may allow bacterial products to escape into the bloodstream and fuel systemic inflammation [(Al-Kufi et al., 2025)](https://pmc.ncbi.nlm.nih.gov/articles/PMC12047224/).
