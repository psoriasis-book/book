...
![Psoriasis comorbidity network](./images/comorbidity-network.svg)
...
![The psoriatic march](./images/psoriatic-march.svg)
...
**Lymphoma.** Psoriasis patients have a relative risk (RR, a measure of how much more likely something is compared with the general population; an RR of 1.0 means the same risk, 2.0 means double the risk) of approximately 1.56 for lymphoma overall, with **cutaneous T-cell lymphoma (CTCL)** showing the strongest association (RR 6.22, meaning about six times the general population's risk). That sounds alarming, but CTCL is extremely rare to begin with, so even a sixfold increase translates to a very small absolute risk. You're far more likely to face cardiovascular or metabolic complications than lymphoma. The elevated RR likely reflects chronic immune stimulation and T-cell proliferation, the same processes that drive psoriasis itself, and some of it may be diagnostic overlap, since early CTCL can mimic psoriasis clinically [(Mateescu et al., 2024)](https://www.mdpi.com/2072-6694/16/24/4224). A biopsy is essential when psoriasis presents atypically or fails to respond to standard therapy.
...
A 2026 study in *Eye* confirmed that biologic therapy is associated with reduced ocular disease, particularly dry eye disease, conjunctivitis, and keratitis, suggesting that systemic inflammation control benefits the eyes as well as the skin and joints [(Kubovsky et al., 2026)](https://www.nature.com/articles/s41433-026-04274-x).
...
- **Sensorineural hearing loss**: OR 3.85 (95% CI: 1.07–13.9). The hearing impairment is predominantly subclinical and most pronounced at high frequencies, with the greatest threshold difference at **6000 Hz** [(Ger et al., 2023)](https://pubmed.ncbi.nlm.nih.gov/37231542/).
- **Sudden sensorineural hearing loss**: HR 1.45 (95% CI: 1.17–1.80).
- **Auditory function changes**: Psoriasis patients show significantly elevated hearing thresholds across multiple frequencies and lower middle ear resonance frequencies compared with matched controls [(Polat & Erbek, 2023)](https://pmc.ncbi.nlm.nih.gov/articles/PMC10447668/).
...
- **Interventional evidence**: Preliminary studies suggest that non-surgical periodontal therapy (scaling and root planing) may positively influence psoriasis severity, possibly by reducing the systemic inflammatory burden [(Marruganti et al., 2025)](https://pubmed.ncbi.nlm.nih.gov/38899599/).
